...
- [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-material-kit-1740383012) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-material-kit-1740383012.git
$ cd django-material-kit-1740383012
```
